...
button_divide = Button(root,text = '/',padx=39, pady=20, command=button_devide)
...
# myButton = Button(root, text='Click Me', command=onClick, fg="white", bg="red")
# myButton.pack()

# myLabel1 = Label(root, text="Hello World").pack()
# myLabel2 = Label(root, text="My name is Isuru").pack()
